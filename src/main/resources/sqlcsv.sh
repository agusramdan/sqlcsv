...
VM_OPTION="-server $GC_LOG_OPTION -XX:+UseParallelGC -XX:+UseParallelOldGC -Xms256m -XX:MaxNewSize=1g -XX:SurvivorRatio=6 -XX:ParallelGCThreads=32 -XX:MaxGCPauseMillis=100 "
